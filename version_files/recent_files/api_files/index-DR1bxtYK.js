...
(function(e) {
  (function(t) {
    ...
    function kn(c, f) {
      ...
      for (s = 253; s >= 0; s--) ft(u, u), s !== 2 && s !== 4 && Re(u, u, f);
    ...
    function U(c, f) {
      var u = n(),
        s;
      for (s = 0; s < 16; s++) u[s] = f[s];
      for (s = 250; s >= 0; s--) ft(u, u), s !== 1 && Re(u, u, f);
      for (s = 0; s < 16; s++) c[s] = u[s]
    }
    ...
    function N(c, f, u) {
      ...
      for (j[0] = re[0] = 1, A = 254; A >= 0; --A) _ = s[A >>> 3] >>> (A & 7) & 1, Fe(j, X, _), Fe(de, re, _), st(ze, j, de), pt(j, j, de), st(de, X, re), pt(X, X, re), ft(re, ze), ft(ae, j), Re(j, de, j), Re(de, X, ze), st(ze, j, de), pt(j, j, de), ft(X, j), pt(de, re, ae), Re(j, de, h), st(j, j, re), Re(de, de, j), Re(j, re, ae), Re(re, X, g), ft(X, ze), Fe(j, X, _), Fe(de, re, _);
      for (A = 0; A < 16; A++) g[A + 16] = j[A], g[A + 32] = de[A], g[A + 48] = X[A], g[A + 64] = re[A];
      var Se = g.subarray(32),
        Ae = g.subarray(16);
      return kn(Se, Se), Re(Ae, Ae, Se), Xe(c, Ae), 0
    }
    ...
    function gn(c, f) {
      var u = n(),
        s = n(),
        g = n();
      kn(g, f[2]), Re(u, f[0], g), Re(s, f[1], g), Xe(c, s), c[31] ^= It(u) << 7
    }

    function Tt(c, f, u) {
      var s, g;
      for (me(c[0], a), me(c[1], l), me(c[2], l), me(c[3], a), g = 255; g >= 0; --g) s = u[g / 8 | 0] >> (g & 7) & 1, An(c, f, s), St(f, c), St(c, c), An(c, f, s)
    }
    ...
    function Jt(c, f) {
      var u = n(),
        ...
        j = n(),
        X = n();
      return me(c[2], l), Ct(c[1], f), ft(g, c[1]), Re(_, g, v), pt(g, g, c[2]), st(_, c[2], _), ft(A, _), ft(j, A), Re(X, j, A), Re(u, X, g), Re(u, u, _), U(u, u), Re(u, u, g), Re(u, u, _), Re(u, u, _), Re(c[0], u, _), ft(s, c[0]), Re(s, s, _), dt(s, g) && Re(c[0], c[0], C), ft(s, c[0]), Re(s, s, _), dt(s, g) ? -1 : (It(c[0]) === f[31] >> 7 && pt(c[0], a, c[0]), Re(c[3], c[0], c[1]), 0)
    }
    ...
    t.lowlevel = {
      ...
      crypto_scalarmult_BYTES: Tn,
      crypto_scalarmult_SCALARBYTES: Gr,
      crypto_box_PUBLICKEYBYTES: vr,
      crypto_box_SECRETKEYBYTES: mr,
      crypto_box_BEFORENMBYTES: Ho,
      crypto_box_NONCEBYTES: zi,
      crypto_box_ZEROBYTES: Al,
      crypto_box_BOXZEROBYTES: Tl,
      crypto_sign_BYTES: vn,
      crypto_sign_PUBLICKEYBYTES: jn,
      crypto_sign_SECRETKEYBYTES: Jn,
      crypto_sign_SEEDBYTES: Fo,
      crypto_hash_BYTES: Ko,
      gf: n,
      D: v,
      L: Ne,
      pack25519: Xe,
    ...
    t.randomBytes = function(c) {
        ...
        if (qt(c, f), c.length !== Gr) throw new Error("bad n size");
        if (f.length !== Tn) throw new Error("bad p size");
        var u = new Uint8Array(Tn);
        return N(u, c, f), u
      }, t.scalarMult.base = function(c) {
        if (qt(c), c.length !== Gr) throw new Error("bad n size");
        var f = new Uint8Array(Tn);
        return $(f, c), f
      }, t.scalarMult.scalarLength = Gr, t.scalarMult.groupElementLength = Tn, t.box = function(c, f, u, s) {
        var g = t.box.before(u, s);
        return t.secretbox(c, f, g)
      }, t.box.before = function(c, f) {
        qt(c, f), Ll(c, f);
        var u = new Uint8Array(Ho);
        return K(u, c, f), u
      ...
      }, t.box.publicKeyLength = vr, t.box.secretKeyLength = mr, t.box.sharedKeyLength = Ho, t.box.nonceLength = zi, t.box.overheadLength = t.secretbox.overheadLength, t.sign = function(c, f) {
        if (qt(c, f), f.length !== Jn) throw new Error("bad secret key size");
        var u = new Uint8Array(vn + c.length);
        return nt(u, c, c.length, f), u
      }, t.sign.open = function(c, f) {
        if (qt(c, f), f.length !== jn) throw new Error("bad public key size");
        ...
        if (u.length !== jn) throw new Error("bad public key size");
        ...
        if (qt(c), c.length !== Jn) throw new Error("bad secret key size");
        for (var f = new Uint8Array(jn), u = 0; u < f.length; u++) f[u] = c[32 + u];
        return {
          publicKey: f,
          secretKey: new Uint8Array(c)
        }
      }, t.sign.keyPair.fromSeed = function(c) {
        if (qt(c), c.length !== Fo) throw new Error("bad seed size");
        for (var f = new Uint8Array(jn), u = new Uint8Array(Jn), s = 0; s < 32; s++) u[s] = c[s];
        return Vt(f, u, !0), {
          publicKey: f,
          secretKey: u
        }
      }, t.sign.publicKeyLength = jn, t.sign.secretKeyLength = Jn, t.sign.seedLength = Fo, t.sign.signatureLength = vn, t.hash = function(c) {
        qt(c);
        var f = new Uint8Array(Ko);
        return ct(f, c, c.length), f
      }, t.hash.hashLength = Ko, t.verify = function(c, f) {
      ...
      function() {
        ...
        } else typeof Rl < "u" && (c = Pl, c && c.randomBytes && t.setPRNG(function(u, s) {
...
function Dl(e, t = !1) {
  let n;
  return e instanceof Uint8Array ? n = e : (typeof e != "string" && (e = JSON.stringify(e)), n = Mr.decodeUTF8(e)), Ul(n, t)
}
...
class ii {
  constructor(t) {
    this.nonceLength = 24, this.keyPair = t ? this.createKeypairFromString(t) : this.createKeypair(), this.sessionId = Vo(this.keyPair.publicKey)
  }
  createKeypair() {
    return zr.box.keyPair()
  }
  createKeypairFromString(t) {
    return {
      publicKey: lo(t.publicKey),
      secretKey: lo(t.secretKey)
    }
  }
  createNonce() {
    return zr.randomBytes(this.nonceLength)
  }
  encrypt(t, n) {
    const r = new TextEncoder().encode(t),
      o = this.createNonce(),
      i = zr.box(r, o, n, this.keyPair.secretKey);
    return jl(o, i)
  }
  decrypt(t, n) {
    const [r, o] = Hl(t, this.nonceLength), i = zr.box.open(o, r, n, this.keyPair.secretKey);
 ...
 keypair secretkey: ${this.keyPair.secretKey.toString()}`);
  ...
  stringifyKeypair() {
    return {
      publicKey: Vo(this.keyPair.publicKey),
      secretKey: Vo(this.keyPair.secretKey)
    }
  }
}
/*! *****************************************************************************
...
class ve extends Error {
  constructor(t, n) {
    super(t, n), this.message = `${ve.prefix} ${this.constructor.name}${this.info?": "+this.info:""}${t?`
`+t:""}`, Object.setPrototypeOf(this, ve.prototype)
  }
  get info() {
    return ""
  }
}
ve.prefix = "[TON_CONNECT_SDK_ERROR]";
class Si extends ve {
  get info() {
...
class Ei extends ve {
  ...
  constructor(...t) {
    super(...t), Object.setPrototypeOf(this, Ei.prototype)
  }
}
class ki extends ve {
  get info() {
...
const ts = {
  [Ln.UNKNOWN_ERROR]: In,
  [Ln.USER_REJECTS_ERROR]: Lo,
  [Ln.BAD_REQUEST_ERROR]: Mo,
  [Ln.UNKNOWN_APP_ERROR]: $o,
  [Ln.MANIFEST_NOT_FOUND_ERROR]: To,
  [Ln.MANIFEST_CONTENT_ERROR]: Ao
};
class Vl {
  parseError(t) {
    let n = In;
    return t.code in ts && (n = ts[t.code] || In), new n(t.message)
  }
}
const ql = new Vl;
class Zl {
...
const ns = {
  [er.UNKNOWN_ERROR]: In,
  [er.USER_REJECTS_ERROR]: Lo,
  [er.BAD_REQUEST_ERROR]: Mo,
  [er.UNKNOWN_APP_ERROR]: $o
};
class Gl extends Zl {
  ...
  parseAndThrowError(t) {
    let n = In;
    throw t.error.code in ns && (n = ns[t.error.code] || In), new n(t.error.message)
  }
...
function Cr(e, t) {
  ...
  return se(this, void 0, void 0, function*() {
    ...
    if (typeof e != "function") throw new ve(`Expected a function, got ${typeof e}`);
    let l = 0,
      h;
    for (; l < o;) {
      if (a.signal.aborted) throw new ve(`Aborted after attempts ${l}`);
      try {
        return yield e({
          signal: a.signal
        })
      } catch (v) {
        h = v, l++, l < o && (yield ra(i))
      }
    }
    throw h
  })
...
function Jl(e, t) {
  ...
  const l = (y, ...w) => se(this, void 0, void 0, function*() {
    if (i = y ?? null, a == null || a.abort(), a = en(y), a.signal.aborted) throw new ve("Resource creation was aborted");
    r = w ?? null;
    const C = e(a.signal, ...w);
    o = C;
    const b = yield C;
    if (o !== C && b !== n) throw yield t(b), new ve("Resource creation was aborted by a new resource creation");
    return n = b, n
  });
  return {
    create: l,
    ...
    recreate: y => se(this, void 0, void 0, function*() {
      const w = n,
        ...
        b = r,
        S = i;
      if (yield ra(y), w === n && C === o && b === r && S === i) return yield l(i, ...b ?? []);
      throw new ve("Resource recreation was aborted by a new resource creation")
    })
  }
}
...
function Xl(e, t) {
  ...
  return new Promise((i, a) => se(this, void 0, void 0, function*() {
    if (o.signal.aborted) {
      a(new ve("Operation aborted"));
      return
    }
    let l;
    typeof n < "u" && (l = setTimeout(() => {
      o.abort(), a(new ve(`Timeout after ${n}ms`))
    }, n)), o.signal.addEventListener("abort", () => {
      clearTimeout(l), a(new ve("Operation aborted"))
    }, {
      once: !0
    });
    const h = {
...
class qo {
  constructor(t, n, r, o, i) {
    this.bridgeUrl = n, this.sessionId = r, this.listener = o, this.errorsListener = i, this.ssePath = "events", this.postPath = "message", this.heartbeatMessage = "heartbeat", this.defaultTtl = 300, this.defaultReconnectDelay = 2e3, this.defaultResendDelay = 5e3, this.eventSource = Jl((a, l) => se(this, void 0, void 0, function*() {
      const h = {
      ...
      a.close()
    })), this.bridgeGatewayStorage = new zl(t, n)
  }
  get isReady() {
  ...
  send(t, n, r, o) {
    ...
    return se(this, void 0, void 0, function*() {
      ...
      const l = new URL(ta(this.bridgeUrl, this.postPath));
      ...
      yield Cr(v => se(this, void 0, void 0, function*() {
        ...
        if (!m.ok) throw new ve(`Bridge send failed, status ${m.status}`)
      }), {
  ...
  pause() {
    this.eventSource.dispose().catch(t => yn(`Bridge pause failed, ${t}`))
  }
  unPause() {
    return se(this, void 0, void 0, function*() {
  ...
  close() {
    return se(this, void 0, void 0, function*() {
      yield this.eventSource.dispose().catch(t => yn(`Bridge close failed, ${t}`))
    })
  }
  setListener(t) {
    this.listener = t
  ...
  post(t, n, r) {
    return se(this, void 0, void 0, function*() {
      ...
      if (!o.ok) throw new ve(`Bridge send failed, status ${o.status}`);
      return o
    })
  }
  errorsHandler(t, n) {
    return se(this, void 0, void 0, function*() {
      if (this.isConnecting) throw t.close(), new ve("Bridge error, failed to connect");
      if (this.isReady) {
        try {
      ...
      throw new ve("Bridge error, unknown state")
    })
  }
  messagesHandler(t) {
    return se(this, void 0, void 0, function*() {
      ...
      try {
        ...
        throw new ve(`Bridge message parse failed, message ${r.data}`)
      }
      this.listener(n)
    })
  }
...
function ec(e) {
  return se(this, void 0, void 0, function*() {
    return yield Xl((t, n, r) => se(this, void 0, void 0, function*() {
      var o;
      const a = en(r.signal).signal;
      if (a.aborted) {
        n(new ve("Bridge connection aborted"));
        return
      }
      const l = new URL(ta(e.bridgeUrl, e.ssePath));
      ...
      v.onerror = m => se(this, void 0, void 0, function*() {
        if (a.aborted) {
          v.close(), n(new ve("Bridge connection aborted"));
          return
        }
        try {
...
class $r {
  ...
  getConnection() {
    return se(this, void 0, void 0, function*() {
      ...
      if ("connectEvent" in n) {
        const r = new ii(n.session.sessionKeyPair);
        return {
          type: "http",
      ...
      return {
        type: "http",
        sessionCrypto: new ii(n.sessionCrypto),
  ...
  getHttpConnection() {
    return se(this, void 0, void 0, function*() {
      ...
      if (!t) throw new ve("Trying to read HTTP connection source while nothing is stored");
      if (t.type === "injected") throw new ve("Trying to read HTTP connection source while injected connection is stored");
      return t
    })
  }
  getHttpPendingConnection() {
    return se(this, void 0, void 0, function*() {
      ...
      if (!t) throw new ve("Trying to read HTTP connection source while nothing is stored");
      if (t.type === "injected") throw new ve("Trying to read HTTP connection source while injected connection is stored");
      if (!Sr(t)) throw new ve("Trying to read HTTP-pending connection while http connection is stored");
      return t
    })
  }
  getInjectedConnection() {
    return se(this, void 0, void 0, function*() {
      const t = yield this.getConnection();
      if (!t) throw new ve("Trying to read Injected bridge connection source while nothing is stored");
      if ((t == null ? void 0 : t.type) === "http") throw new ve("Trying to read Injected bridge connection source while HTTP connection is stored");
      return t
    })
  }
...
class Rr {
  constructor(t, n) {
    this.storage = t, this.walletConnectionSource = n, this.type = "http", this.standardUniversalLink = "tc://", this.pendingRequests = new Map, this.session = null, this.gateway = null, this.pendingGateways = [], this.listeners = [], this.defaultOpeningDeadlineMS = 12e3, this.defaultRetryTimeoutMS = 2e3, this.connectionStorage = new $r(t)
  }
  static fromStorage(t) {
    return se(this, void 0, void 0, function*() {
      const r = yield new $r(t).getHttpConnection();
      return Sr(r) ? new Rr(t, r.connectionSource) : new Rr(t, {
  ...
  restoreConnection(t) {
    ...
    return se(this, void 0, void 0, function*() {
      ...
      if (Array.isArray(this.walletConnectionSource)) throw new ve("Internal error. Connection source is array while WalletConnectionSourceHTTP was expected.");
  ...
  sendRequest(t, n) {
    ...
    return typeof n == "function" ? r.onRequestSent = n : (r.onRequestSent = n == null ? void 0 : n.onRequestSent, r.signal = n == null ? void 0 : n.signal, r.attempts = n == null ? void 0 : n.attempts), new Promise((o, i) => se(this, void 0, void 0, function*() {
      var a;
      if (!this.gateway || !this.session || !("walletPublicKey" in this.session)) throw new ve("Trying to send bridge request without session");
      ...
      const h = this.session.sessionCrypto.encrypt(JSON.stringify(Object.assign(Object.assign({}, t), {
        id: l
      })), lo(this.session.walletPublicKey));
      try {
  ...
  gatewayListener(t) {
    return se(this, void 0, void 0, function*() {
      const n = JSON.parse(this.session.sessionCrypto.decrypt(Ci.decode(t.message).toUint8Array(), lo(t.from)));
      ...
      if (n.id !== void 0) {
        ...
        if (o !== void 0 && n.id <= o) {
          yn(`Received event id (=${n.id}) must be greater than stored last wallet event id (=${o}) `);
          return
        }
  ...
  gatewayErrorsListener(t) {
    return se(this, void 0, void 0, function*() {
      throw new ve(`Bridge error ${JSON.stringify(t)}`)
    })
  }
  updateSession(t, n) {
    return se(this, void 0, void 0, function*() {
  ...
  generateUniversalLink(t, n) {
    return Rn(t) ? this.generateTGUniversalLink(t, n) : this.generateRegularUniversalLink(t, n)
  }
  generateRegularUniversalLink(t, n) {
    const r = new URL(t);
    return r.searchParams.append("v", oa.toString()), r.searchParams.append("id", this.session.sessionCrypto.sessionId), r.searchParams.append("r", JSON.stringify(n)), r.toString()
  }
...
function tc(e) {
  try {
    return !rs(e, "tonconnect") || !rs(e.tonconnect, "walletInfo") ? !1 : ia(e.tonconnect.walletInfo, ["name", "app_name", "image", "about_url", "platforms"])
  } catch {
    return !1
  }
}
...
function ic() {
  var e;
  const t = (e = Ro()) === null || e === void 0 ? void 0 : e.location.origin;
  return t ? t + "/tonconnect-manifest.json" : ""
}

function sc() {
  if (ac()) return localStorage;
  if (lc()) throw new ve("`localStorage` is unavailable, but it is required for TonConnect. For more details, see https://github.com/ton-connect/sdk/tree/main/packages/sdk#init-connector");
...
class Kt {
  constructor(t, n) {
    ...
    const r = Kt.window;
    if (!Kt.isWindowContainsWallet(r, n)) throw new Ei;
    this.connectionStorage = new $r(t), this.injectedWallet = r[n].tonconnect
  }
  static fromStorage(t) {
    return se(this, void 0, void 0, function*() {
      const r = yield new $r(t).getInjectedConnection();
  ...
  static getCurrentlyInjectedWallets() {
    return this.window ? rc().filter(([r, o]) => tc(o)).map(([r, o]) => ({
...
function Vn(e) {
  return uc(e) && e.injected
}

function Bo(e) {
  return Vn(e) && e.embedded
}
...
class si {
  ...
  getEmbeddedWallet() {
    return se(this, void 0, void 0, function*() {
      const n = (yield this.getWallets()).filter(Bo);
  ...
  fetchWalletsList() {
    return se(this, void 0, void 0, function*() {
      let t = [];
      try {
        if (t = yield(yield fetch(this.walletsListSource)).json(), !Array.isArray(t)) throw new ki("Wrong wallets list format, wallets list must be an array.");
        const o = t.filter(i => !this.isCorrectWalletConfigDTO(i));
        o.length && (yn(`Wallet(s) ${o.map(i=>i.name).join(", ")} config format is wrong. They were removed from the wallets list.`), t = t.filter(i => this.isCorrectWalletConfigDTO(i)))
      } catch (r) {
        yn(r), t = dc
      }
      let n = [];
...
function fc(e, t) {
  ...
  if (!n && !r) throw new fo("Wallet doesn't support SendTransaction feature.");
  if (r && r.maxMessages !== void 0) {
    if (r.maxMessages < t.requiredMessagesNumber) throw new fo(`Wallet is not able to handle such SendTransaction request. Max support messages number is ${r.maxMessages}, but ${t.requiredMessagesNumber} is required.`);
    return
  }
  Ql("Connected wallet didn't provide information about max allowed messages in the SendTransaction request. Request may be rejected by the wallet.")
}
...
class hc {
  constructor(t) {
    var n;
    this.eventPrefix = "ton-connect-", this.tonConnectUiVersion = null, this.eventDispatcher = (n = t == null ? void 0 : t.eventDispatcher) !== null && n !== void 0 ? n : new pa, this.tonConnectSdkVersion = t.tonConnectSdkVersion, this.init().catch()
  }
  get version() {
    return zn({
  ...
  setRequestVersionHandler() {
    return se(this, void 0, void 0, function*() {
      yield this.eventDispatcher.addEventListener("ton-connect-request-version", () => se(this, void 0, void 0, function*() {
        yield this.eventDispatcher.dispatchEvent("ton-connect-response-version", aa(this.tonConnectSdkVersion))
      }))
    })
  }
      ...
      return new Promise((t, n) => se(this, void 0, void 0, function*() {
        try {
          yield this.eventDispatcher.addEventListener("ton-connect-ui-response-version", r => {
            ...
            once: !0
          }), yield this.eventDispatcher.dispatchEvent("ton-connect-ui-request-version", sa())
        } catch (r) {
          n(r)
        }
      }))
...
class Gn {
  constructor(t) {
    if (this.walletsList = new si, this._wallet = null, this.provider = null, this.statusChangeSubscriptions = [], this.statusChangeErrorSubscriptions = [], this.dappSettings = {
        manifestUrl: (t == null ? void 0 : t.manifestUrl) || ic(),
        storage: (t == null ? void 0 : t.storage) || new cc
      }, this.walletsList = new si({
      ...
      }), !this.dappSettings.manifestUrl) throw new Si("Dapp tonconnect-manifest.json must be specified if window.location.origin is undefined. See more https://github.com/ton-connect/docs/blob/main/requests-responses.md#app-manifest");
    this.bridgeConnectionStorage = new $r(this.dappSettings.storage), t != null && t.disableAutoPauseConnection || this.addWindowFocusAndBlurSubscriptions()
  }
  static getWallets() {
  ...
  connect(t, n) {
    var r, o;
    const i = {};
    if (typeof n == "object" && "tonProof" in n && (i.request = n), typeof n == "object" && ("openingDeadlineMS" in n || "signal" in n || "request" in n) && (i.request = n == null ? void 0 : n.request, i.openingDeadlineMS = n == null ? void 0 : n.openingDeadlineMS, i.signal = n == null ? void 0 : n.signal), this.connected) throw new _i;
    const a = en(i == null ? void 0 : i.signal);
    if ((r = this.abortController) === null || r === void 0 || r.abort(), this.abortController = a, a.signal.aborted) throw new ve("Connection was aborted");
  ...
  restoreConnection(t) {
    ...
    return se(this, void 0, void 0, function*() {
      ...
      try {
        switch (i) {
          case "http":
            l = yield Rr.fromStorage(this.dappSettings.storage);
            break;
          case "injected":
      ...
      if (!l) {
        yn("Provider is not restored"), this.tracker.trackConnectionRestoringError("Provider is not restored");
        return
  ...
  sendTransaction(t, n) {
    return se(this, void 0, void 0, function*() {
      ...
      if (o.signal.aborted) throw new ve("Transaction sending was aborted");
      ...
      const {
        validUntil: i
      } = t, a = Fl(t, ["validUntil"]), l = t.from || this.account.address, h = t.network || this.account.chain, v = yield this.provider.sendRequest(Yr.convertToRpcRequest(Object.assign(Object.assign({}, a), {
        valid_until: i,
        from: l,
        network: h
      })), {
      ...
      if (Yr.isError(v)) return this.tracker.trackTransactionSigningFailed(this.wallet, t, v.error.message, v.error.code), Yr.parseAndThrowError(v);
      const m = Yr.convertFromRpcResponse(v);
  ...
  disconnect(t) {
    var n;
    return se(this, void 0, void 0, function*() {
      if (!this.connected) throw new co;
      const r = en(t == null ? void 0 : t.signal),
        o = this.abortController;
      if (this.abortController = r, r.signal.aborted) throw new ve("Disconnect was aborted");
  ...
  addWindowFocusAndBlurSubscriptions() {
    ...
    if (t) try {
      ...
      yn("Cannot subscribe to the document.visibilitychange: ", n)
    }
  }
  createProvider(t) {
    let n;
    return !Array.isArray(t) && Kl(t) ? n = new Kt(this.dappSettings.storage, t.jsBridgeKey) : n = new Rr(this.dappSettings.storage, t), n.listen(this.walletEventsListener.bind(this)), n
  }
  ...
  onWalletConnected(t) {
    ...
    if (!n) throw new ve("ton_addr connection item was not found");
    const o = {
      device: t.device,
  ...
  onWalletConnectError(t) {
    const n = ql.parseError(t);
    if (this.statusChangeErrorSubscriptions.forEach(r => r(n)), Et(n), this.tracker.trackConnectionError(t.message, t.code), n instanceof To || n instanceof Ao) throw yn(n), n
  }
...
Gn.walletsList = new si;
Gn.isWalletInjected = e => Kt.isWalletInjected(e);
Gn.isInsideWalletBrowser = e => Kt.isInsideWalletBrowser(e);
const vc = 81,
  mc = 128;
...
function ya(e, t = !1) {
  ...
  return a.set(i), a.set(pc(i), 34), Ci.encode(a).replace(/\+/g, "-").replace(/\//g, "_")
}

function wc(e) {
  if (!e.includes(":")) throw new tr(`Wrong address ${e}. Address must include ":".`);
  const t = e.split(":");
  if (t.length !== 2) throw new tr(`Wrong address ${e}. Address must include ":" only once.`);
  const n = parseInt(t[0]);
  if (n !== 0 && n !== -1) throw new tr(`Wrong address ${e}. WC must be eq 0 or -1, but ${n} received.`);
  const r = t[1];
  if ((r == null ? void 0 : r.length) !== 64) throw new tr(`Wrong address ${e}. Hex part must be 64bytes length, but ${r==null?void 0:r.length} received.`);
  return {
    wc: n,
    hex: yc(r)
  }
...
for (let e = 0; e <= 255; e++) {
  let t = e.toString(16);
  t.length < 2 && (t = "0" + t), ai[t] = e
}

function yc(e) {
  e = e.toLowerCase();
  const t = e.length;
  if (t % 2 !== 0) throw new uo("Hex string must have length a multiple of 2: " + e);
  const n = t / 2,
    r = new Uint8Array(n);
  for (let o = 0; o < n; o++) {
    const i = o * 2,
      a = e.substring(i, i + 2);
    if (!ai.hasOwnProperty(a)) throw new uo("Invalid hex character: " + a);
    r[o] = ai[a]
  }
  return r
}
...
function Bc(e, t, n) {
  var r = {};
  return n.isMergeableObject(e) && os(e).forEach(function(o) {
    r[o] = Br(e[o], n)
  }), os(t).forEach(function(o) {
    Rc(e, o) || (ba(e, o) && n.isMergeableObject(t[o]) ? r[o] = Mc(o, n)(e[o], t[o], n) : r[o] = Br(t[o], n))
  }), r
}

function ar(e, t, n) {
  n = n || {}, n.arrayMerge = n.arrayMerge || Lc, n.isMergeableObject = n.isMergeableObject || Cc, n.cloneUnlessOtherwiseSpecified = Br;
  var r = Array.isArray(t),
    o = Array.isArray(e),
    i = r === o;
  return i ? r ? n.arrayMerge(e, t, n) : Bc(e, t, n) : Br(t, n)
}
ar.all = function(t, n) {
...
var Nc = Object.defineProperty,
  ...
  et = (e, t) => {
    for (var n in t || (t = {})) jc.call(t, n) && ci(e, n, t[n]);
    if (is)
      for (var n of is(t)) Hc.call(t, n) && ci(e, n, t[n]);
    return e
  },
  Gt = (e, t) => Dc(e, Oc(t)),
  ye = (e, t, n) => (ci(e, typeof t != "symbol" ? t + "" : t, n), n),
...
function xe(e, t) {
  ...
  const n = {
    ...
    r = o => (typeof o == "function" && (o = o(n.value)), Ta(n, o));
  return [Aa.bind(n), r]
}
...
function At(e, t, n) {
  Ca = Qc;
  const r = Wo(e, t, !1, Sn);
  r.user = !0, bn ? bn.push(r) : hr(r)
}

function ie(e, t, n) {
  n = n ? Object.assign({}, ho, n) : ho;
  const r = Wo(e, t, !0, 0);
  return r.observers = null, r.observerSlots = null, r.comparator = n.equals || void 0, hr(r), Aa.bind(r)
}
...
function Vc(e, t, n) {
  ...
  if (ut.context) {
    h = `${ut.context.id}${ut.context.count++}`;
    let E;
    i.ssrLoadFrom === "initial" ? l = i.initialValue : ut.load && (E = ut.load(h)) && (l = E[0])
  }
  ...
  function R(E = !0) {
    ...
    const k = l !== Zo ? l : Mt(() => o(W, {
      value: C(),
      refetching: E
    }));
    return typeof k != "object" || !(k && "then" in k) ? (B(a, k, void 0, W), k) : (a = k, v = !0, queueMicrotask(() => v = !1), Pn(() => {
      z(m ? "refreshing" : "pending"), V()
    }, !1), k.then(x => B(k, x, void 0, W), x => B(k, void 0, $a(x), W)))
  }
...
function Ht(e) {
  let t;
  return (t = Ba(kt, e.id)) !== void 0 ? t : e.defaultValue
}
...
function Aa() {
  ...
  if (this.sources && (this.state || e))
    if (this.state === Sn || e) hr(this);
    else {
      const t = Dt;
      Dt = null, Pn(() => wo(this), !1), Dt = t
    } if (ht) {
...
function Ta(e, t, n) {
  let r = e.value;
  return (!e.comparator || !e.comparator(r, t)) && (e.value = t, e.observers && e.observers.length && Pn(() => {
    for (let o = 0; o < e.observers.length; o += 1) {
      const i = e.observers[o],
        a = qn && qn.running;
      a && qn.disposed.has(i), (a && !i.tState || !a && !i.state) && (i.pure ? Dt.push(i) : bn.push(i), i.observers && Ma(i)), a || (i.state = Sn)
    }
...
function hr(e) {
  ...
  const t = kt,
    n = ht,
    r = Li;
  ht = kt = e, zc(e, e.value, r), ht = n, kt = t
}
...
function zc(e, t, n) {
  ...
  try {
    ...
    e.pure && (e.state = Sn, e.owned && e.owned.forEach(Uo), e.owned = null), Ra(o)
  }(!e.updatedAt || e.updatedAt <= n) && (e.updatedAt != null && "observers" in e ? Ta(e, r) : e.value = r, e.updatedAt = n)
}

function Wo(e, t, n, r = Sn, o) {
  const i = {
    fn: e,
    state: r,
    updatedAt: null,
  ...
  return kt === null || kt !== Sa && (kt.owned ? kt.owned.push(i) : kt.owned = [i]), i
}

function mo(e) {
  const t = qn;
  if (e.state === 0 || t) return;
  if (e.state === go || t) return wo(e);
  if (e.suspense && Mt(e.suspense.inFallback)) return e.suspense.effects.push(e);
  const n = [e];
  for (;
    (e = e.owner) && (!e.updatedAt || e.updatedAt < Li);)(e.state || t) && n.push(e);
  for (let r = n.length - 1; r >= 0; r--)
    if (e = n[r], e.state === Sn || t) hr(e);
    else if (e.state === go || t) {
    const o = Dt;
    Dt = null, Pn(() => wo(e, n[0]), !1), Dt = o
  }
}
...
function Pn(e, t) {
  ...
  try {
    ...
    n || (bn = null), Dt = null, Ra(r)
  }
}

function Yc(e) {
  if (Dt && (La(Dt), Dt = null), e) return;
  const t = bn;
  bn = null, t.length && Pn(() => Ca(t), !1)
}

function La(e) {
  for (let t = 0; t < e.length; t++) mo(e[t])
}
...
function Qc(e) {
  ...
  for (ut.context && Fc(), t = 0; t < n; t++) mo(e[t])
}
...
function wo(e, t) {
  ...
  for (let r = 0; r < e.sources.length; r += 1) {
    const o = e.sources[r];
    o.sources && (o.state === Sn || n ? o !== t && mo(o) : (o.state === go || n) && wo(o, t))
  }
}
...
function Ma(e) {
  ...
  for (let n = 0; n < e.observers.length; n += 1) {
    ...
    (!r.state || t) && (r.state = go, r.pure ? Dt.push(r) : bn.push(r), r.observers && Ma(r))
  }
}
...
function Uo(e) {
  ...
  if (e.owned) {
    for (t = 0; t < e.owned.length; t++) Uo(e.owned[t]);
    e.owned = null
  }
  if (e.cleanups) {
...
function Ba(e, t) {
  return e ? e.context && e.context[t] !== void 0 ? e.context[t] : Ba(e.owner, t) : void 0
}
...
function e0(e, t, n = {}) {
  ...
  return jt(() => gs(i)), () => {
    ...
    return h[ui], Mt(() => {
      let w = h.length,
        C, b, S, M, ee, V, D, z, B;
      if (w === 0) a !== 0 && (gs(i), i = [], r = [], o = [], a = 0, l && (l = [])), n.fallback && (r = [Xc], o[0] = _r(q => (i[0] = q, n.fallback())), a = 1);
      else if (a === 0) {
...
function sn(...e) {
  ...
  if (t) return new Proxy({
    ...
    has(r) {
      for (let o = e.length - 1; o >= 0; o--)
        if (r in Go(e[o])) return !0;
      return !1
    },
    keys() {
      const r = [];
      for (let o = 0; o < e.length; o++) r.push(...Object.keys(Go(e[o])));
      return [...new Set(r)]
    }
  }, fi);
  const n = {};
...
function h0(e, t, n = {}) {
  ...
  for (i = 0, a = o.length; i < a; i++) {
    const l = o[i];
    !l || l === "undefined" || t[l] || (ws(e, l, !1), delete n[l])
  }
  for (i = 0, a = r.length; i < a; i++) {
    const l = r[i],
      h = !!t[l];
    !l || l === "undefined" || n[l] === h || !h || (ws(e, l, !0), n[l] = h)
  }
  return n
}
...
function Ia(e, t = {}, n, r) {
  const o = {};
  return Oe(() => o.children = Ir(e, t.children, o.children)), Oe(() => t.ref && t.ref(e)), Oe(() => v0(e, t, n, !0, o, !0)), o
}
...
function Rt(e, t, n, r) {
  if (n !== void 0 && !r && (r = []), typeof t != "function") return Ir(e, t, r, n);
  Oe(o => Ir(e, t(), o, n), r)
}
...
function v0(e, t, n, r, o = {}, i = !1) {
  ...
  for (const a in o)
    if (!(a in t)) {
      ...
      o[a] = ps(e, a, null, o[a], n, i)
    } for (const a in t) {
    if (a === "children") continue;
    const l = t[a];
    o[a] = ps(e, a, l, o[a], n, i)
  }
}

function m0(e) {
  let t, n;
  return !ut.context || !(t = ut.registry.get(n = y0())) ? e.cloneNode(!0) : (ut.completed && ut.completed.add(t), ut.registry.delete(n), t)
}
...
function ps(e, t, n, r, o, i) {
  ...
  } else if ((h = r0.has(t)) || !o && (vs[t] || (l = n0.has(t))) || (a = e.nodeName.includes("-"))) t === "class" || t === "className" ? $i(e, n) : a && !l && !h ? e[w0(t)] = n : e[vs[t] || t] = n;
  else {
    const v = o && t.indexOf(":") > -1 && a0[t.split(":")[0]];
    v ? d0(e, v, t, n) : ge(e, o0[t] || t, n)
  }
  return n
}
...
function p0(e) {
  ...
  for (e.target !== n && Object.defineProperty(e, "target", {
    ...
    }), ut.registry && !ut.done && (ut.done = !0, document.querySelectorAll("[id^=pl-]").forEach(r => {
...
function Ir(e, t, n, r, o) {
  for (ut.context && !n && (n = [...e.childNodes]); typeof n == "function";) n = n();
  if (t === n) return n;
  const i = typeof t,
    a = r !== void 0;
  if (e = a && n[0] && n[0].parentNode || e, i === "string" || i === "number") {
    if (ut.context) return n;
    if (i === "number" && (t = t.toString()), a) {
      let l = n[0];
      l && l.nodeType === 3 ? l.data = t : l = document.createTextNode(t), n = Xn(e, n, r, l)
    ...
    if (Array.isArray(t)) {
      const l = [],
        h = n && Array.isArray(n);
      if (hi(l, t, n, o)) return Oe(() => n = Ir(e, l, n, r, !0)), () => n;
      if (ut.context) {
      ...
      if (l.length === 0) {
        if (n = Xn(e, n, r), a) return n
      } else h ? n.length === 0 ? ys(e, l, r) : l0(e, n, l) : (n && Xn(e), ys(e, l));
      n = l
    } else if (t instanceof Node) {
      if (ut.context && t.parentNode) return n = a ? [t] : t;
      if (Array.isArray(n)) {
        if (a) return n = Xn(e, n, r, t);
        Xn(e, n, null, t)
...
function hi(e, t, n, r) {
  ...
  for (let i = 0, a = t.length; i < a; i++) {
    ...
    if (l instanceof Node) e.push(l);
      ...
      if (Array.isArray(l)) o = hi(e, l, h) || o;
      else if (typeof l == "function")
      if (r) {
        for (; typeof l == "function";) l = l();
        o = hi(e, Array.isArray(l) ? l : [l], Array.isArray(h) ? h : [h]) || o
      } else e.push(l), o = !0;
    else {
      const v = String(l);
...
function Wa(e) {
  ...
  if (r instanceof HTMLHeadElement) {
    ...
    _r(h => Rt(r, () => i() ? h() : o()(), null)), jt(() => {
      ut.context ? queueMicrotask(l) : l()
    })
  } else {
    const i = Pa(e.isSVG ? "g" : "div", e.isSVG),
...
function lr(e) {
  const [t, n] = Mi(e, ["component"]), r = ie(() => t.component);
  return ie(() => {
    const o = r();
    switch (typeof o) {
      case "function":
      ...
      case "string":
        const i = s0.has(o),
          a = ut.context ? m0() : Pa(o, i);
        return Ia(a, n, i), a
    }
  })
}
var gt = (e => (e.DARK = "DARK", e.LIGHT = "LIGHT", e))(gt || {});
let x0 = {
    data: ""
  },
  ...
  Hn = (e, t) => {
    ...
    for (let i in e) {
      let a = e[i];
      i[0] == "@" ? i[1] == "i" ? n = i + " " + a + ";" : r += i[1] == "f" ? Hn(a, i) : i + "{" + Hn(a, i[1] == "k" ? "" : t) + "}" : typeof a == "object" ? r += Hn(a, t ? t.replace(/([^,])+/g, l => i.replace(/(^:.*)|([^,])+/g, h => /&/.test(h) ? h.replace(/&/g, l) : l ? l + " " + h : h)) : i) : a != null && (i = /^--/.test(i) ? i : i.replace(/[A-Z]/g, "-$&").toLowerCase(), o += Hn.p ? Hn.p(i, a) : i + ":" + a + ";")
    }
  ...
  E0 = (e, t, n, r, o) => {
    ...
    if (!mn[a]) {
      let h = i !== e ? e : (v => {
        let m, y, w = [{}];
        for (; m = S0.exec(v.replace(_0, ""));) m[4] ? w.shift() : m[3] ? (y = m[3].replace(bs, " ").trim(), w.unshift(w[0][y] = w[0][y] || {})) : w[0][m[1]] = m[2].replace(bs, " ").trim();
        return w[0]
      })(e);
      mn[a] = Hn(o ? {
        ["@keyframes " + a]: h
  ...
  k0 = (e, t, n) => e.reduce((r, o, i) => {
    ...
    if (a && a.call) {
      ...
      a = h ? "." + h : l && typeof l == "object" ? l.props ? "" : Hn(l, "") : l === !1 ? "" : l
    }
    return r + o + (a ?? "")
  }, "");
  ...
  return (...n) => {
    const r = o => {
      const i = Ht(Ri),
        ...
        y = h.as || e;
      let w;
      return typeof y == "function" ? w = y(m) : t.g == 1 ? (w = document.createElement(y), Ia(w, m)) : w = lr(sn({
        component: y
      }, m)), w
    };
    return r.class = o => Mt(() => Cn.apply({
      target: t.target,
      p: o,
      g: t.g
    }, n)), r
...
const wn = "tc-root",
  Bi = "tc-disable-scroll",
  zo = "tc-using-mouse",
  M0 = () => {
    document.body.addEventListener("mousedown", () => document.body.classList.add(zo)), document.body.addEventListener("keydown", t => {
      t.key === "Tab" && document.body.classList.remove(zo)
    });
    const e = L0`
    ${wn} * {
        margin: 0;
...
function Er(e, t = "_self") {
  io("openLink", e, t), window.open(e, t, "noopener noreferrer")
}
...
function I0() {
  return window.matchMedia && window.matchMedia("(prefers-color-scheme: light)").matches ? gt.LIGHT : gt.DARK
}

function P0(e) {
  const t = n => e(n.matches ? gt.DARK : gt.LIGHT);
...
function W0() {
  document.documentElement.scrollHeight !== document.documentElement.clientHeight && (document.body.style.top = an(-document.documentElement.scrollTop), document.body.classList.add(Bi))
}

function U0() {
  document.body.classList.remove(Bi), document.documentElement.scrollTo({
...
function D0() {
  customElements.define(wn, class extends HTMLElement {})
}
...
function ja(e) {
  document.readyState !== "complete" ? window.addEventListener("load", () => Oa(() => ja(e)), {
    once: !0
  }) : e.forEach(t => {
...
function Ii() {
  ...
  if (H0()) throw new xt("`localStorage` is unavailable, but it is required for TonConnect. For more details, see https://github.com/ton-connect/sdk/tree/main/packages/sdk#init-connector");
...
function Xt(...e) {
  return e.includes(Pi().os)
}

function Ue(...e) {
  return e.includes(Pi().browser)
}
...
class F0 {
  constructor() {
    ye(this, "localStorage"), ye(this, "storageKey", "ton-connect-ui_wallet-info"), this.localStorage = Ii()
  }
  setWalletInfo(t) {
...
class K0 {
  constructor() {
    ye(this, "localStorage"), ye(this, "storageKey", "ton-connect-ui_preferred-wallet"), this.localStorage = Ii()
  }
...
class Ha {
  constructor() {
    ye(this, "localStorage"), ye(this, "storageKey", "ton-connect-ui_last-selected-wallet-info"), this.localStorage = Ii()
  }
...
const [gi, xs] = xe({
  status: "closed",
  closeReason: null
}), Cs = ie(() => gi().status === "opened"), [po, Ss] = xe({
  status: "closed",
  closeReason: null
}), _s = ie(() => po().status === "opened"), V0 = ie(() => {
  const e = po();
  return e.status === "opened" ? e.walletInfo : null
});
let nr = typeof window < "u" ? new Ha : void 0;
const [q0, Z0] = xe((nr == null ? void 0 : nr.getLastSelectedWalletInfo()) || null), Bt = e => {
  nr || (nr = new Ha), e ? nr.setLastSelectedWalletInfo(e) : nr.removeLastSelectedWalletInfo(), Z0(e)
}, [pn, rr] = xe(null), G0 = {
  close: "Close",
...
function Wi(e) {
  let t = e[Pr];
  return t || Object.defineProperty(e, Pr, {
    value: t = {}
  }), t
}
...
function u1(e, t) {
  ...
  return !n || n.get || !n.configurable || t === tn || t === Pr || t === c1 || (delete n.value, delete n.writable, n.get = () => e[tn][t]), n
}
...
const f1 = {
  get(e, t, n) {
    if (t === vi) return e;
    if (t === tn) return n;
    if (t === ui) return Ka(e), n;
    const r = Wi(e),
      o = r.hasOwnProperty(t);
    let i = o ? r[t]() : e[t];
    if (t === Pr || t === "__proto__") return i;
    if (!o) {
      const a = Object.getOwnPropertyDescriptor(e, t);
      ka() && (typeof i != "function" || e.hasOwnProperty(t)) && !(a && a.get) && (i = mi(r, t, i)())
    }
    return yo(i) ? Fa(i) : i
  },
  has(e, t) {
    return t === vi || t === tn || t === ui || t === Pr || t === "__proto__" ? !0 : (this.get(e, t, e), t in e)
  },
  set() {
    return !0
  },
...
function bo(e, t, n, r = !1) {
  ...
  let a = Wi(e),
    l;
  (l = mi(a, t, o)) && l.$(() => n), Array.isArray(e) && e.length !== i && (l = mi(a, "length", i)) && l.$(e.length), (l = a._) && l.$()
}
...
function yr(e, t, n = []) {
  ...
  let i = t[0];
  typeof i == "function" && (i = i(o, n), i === o) || r === void 0 && i == null || (i = cr(i), r === void 0 || yo(o) && yo(i) && !Array.isArray(i) ? qa(o, i) : bo(e, r, i))
}
...
function v1(e) {
  var t, n;
  return ks(e) === !1 ? !1 : (t = e.constructor, t === void 0 ? !0 : (n = t.prototype, !(ks(n) === !1 || n.hasOwnProperty("isPrototypeOf") === !1)))
}
...
function Yo(e, t) {
  t && (rn[gt.DARK] = Bn(t[gt.DARK], rn[gt.DARK]), rn[gt.LIGHT] = Bn(t[gt.LIGHT], rn[gt.LIGHT])), Ni({
    theme: e,
    colors: Bn(rn[e], Ga[e])
  })
}
...
function p1(e) {
  rn[gt.DARK] = Bn(e[gt.DARK], rn[gt.DARK]), rn[gt.LIGHT] = Bn(e[gt.LIGHT], rn[gt.LIGHT]), Ni(t => ({
    colors: Bn(rn[t.theme], Ga[t.theme])
  }))
}
const y1 = I.div`
...
let ur = "unknown";
Zn != null && Zn.tgWebAppPlatform && (ur = (ss = Zn.tgWebAppPlatform) != null ? ss : "unknown");
if (ur === "unknown") {
  const e = dn();
  ur = (cs = (ls = (as = e == null ? void 0 : e.Telegram) == null ? void 0 : as.WebApp) == null ? void 0 : ls.platform) != null ? cs : "unknown"
}
let xo = "6.0";
Zn != null && Zn.tgWebAppVersion && (xo = Zn.tgWebAppVersion);
if (!xo) {
  const e = dn();
  xo = (fs = (ds = (us = e == null ? void 0 : e.Telegram) == null ? void 0 : us.WebApp) == null ? void 0 : ds.version) != null ? fs : "6.0"
}
...
function wi(e, t) {
  ...
  Ya() || S1("6.1") ? Qa("web_app_open_tg_link", {
    path_full: r
  }) : at("https://t.me" + r)
}
...
function Qa(e, t) {
  try {
    ...
    if (n.TelegramWebviewProxy !== void 0) io("postEvent", e, t), n.TelegramWebviewProxy.postEvent(e, JSON.stringify(t));
    else if (n.external && "notify" in n.external) io("postEvent", e, t), n.external.notify(JSON.stringify({
      eventType: e,
      eventData: t
    }));
    else if (Ya()) {
      ...
      io("postEvent", e, t), n.parent.postMessage(o, r)
    } else throw new xt("Can't post event to TMA")
  } catch (n) {
...
function b1(e) {
  ...
  if (e.indexOf("=") < 0 && e.indexOf("?") < 0) return t._path = Co(e), t;
  let n = e.indexOf("?");
  if (n >= 0) {
    let o = e.substr(0, n);
    t._path = Co(o), e = e.substr(n + 1)
  }
  let r = x1(e);
...
function x1(e) {
  ...
  let n = e.split("&"),
    r, o, i, a;
  for (r = 0; r < n.length; r++) o = n[r].split("="), i = Co(o[0]), a = o[1] == null ? null : Co(o[1]), t[i] = a;
  return t
}
...
function or(e) {
  ...
  switch (e) {
    ...
    default:
    case "mobile":
      return n <= Kn.mobile || Xt("ios", "android", "ipad")
  }
}
...
function Yt(e) {
  switch (e) {
    case "mobile":
      return `@media (max-width: ${Kn.mobile}px)`;
    case "tablet":
      return `@media (max-width: ${Kn.tablet}px) (min-width: ${Kn.mobile}px)`;
    default:
    case "desktop":
      return `@media (min-width: ${Kn.tablet}px)`
  }
}
const Hr = "@media (hover: none)",
  Fr = "@media not all and (hover: none)",
  _1 = {
    m: "100vh",
    s: "8px",
    none: "0"
  ...
  E1 = I.button`
    ...
    background-color: ${e=>e.appearance==="flat"?"transparent":e.appearance==="secondary"?e.theme.colors.background.tint:jr(e.theme.colors.accent,.12)};
    ...
    ${Fr} {
        &:hover {
            transform: ${e=>e.disabled?"unset":`scale(${1+Qo[e.scale]})`};
        }
    }
    ...
    ${Hr} {
        &:active {
            transform: ${e=>e.disabled?"unset":`scale(${1-Qo[e.scale]*2})`};
        }
    }
`;
...
const Oi = e => {
  let t, n = !0;
  const [r, o] = xe(), [i, a] = xe(), l = Po(() => e.children), {
    onBeforeEnter: h,
    onEnter: v,
    onAfterEnter: m,
    onBeforeExit: y,
  ...
  function S(ee, V) {
    if (!n || e.appear) {
      let D = function(P) {
        ee && (!P || P.target === ee) && (ee.removeEventListener("transitionend", D), ee.removeEventListener("animationend", D), ee.classList.remove(...B), ee.classList.remove(...q), _a(() => {
      ...
      h && h(ee), ee.classList.add(...z), ee.classList.add(...B), So(() => {
  ...
  function M(ee, V) {
    ...
    y && y(V), V.classList.add(...D), V.classList.add(...z), So(() => {
  ...
  return vo(() => {
    ...
    for (let P = 0; P < C.length; P++) {
      ...
      if (!w && !M.has(R)) {
        ...
        r && r(R), R.classList.add(...ee), R.classList.add(...V), So(() => {
    ...
    for (let P = 0; P < y.length; P++) {
      ...
      if (!S.has(R) && R.parentNode) {
        ...
        b.splice(P, 0, R), a && a(R), R.classList.add(...z), R.classList.add(...B), So(() => {
    ...
    return b.forEach(S => {
      let M;
      (M = C.get(S)) ? M.new && (M.new = !1, M.newPos = Xr(S)): C.set(S, M = {
        pos: Xr(S),
        new: !w
      }), M.new && S.addEventListener("transitionend", () => {
        M.new = !1, S.parentNode && (M.newPos = Xr(S))
      }, {
        once: !0
      }), M.newPos && (M.pos = M.newPos), M.newPos = Xr(S)
    }), w ? (w = !1, C) : (b.forEach(S => {
      const M = C.get(S),
        ee = M.pos,
        V = M.newPos,
...
function L1(e, t) {
  ...
  window.addEventListener("popstate", i, {
    ...
    window.removeEventListener("popstate", i), Oa(() => {
      var a;
      ((a = window.history.state) == null ? void 0 : a[Ja]) === !0 && window.history.back()
    })
  })
}
const Ja = "androidBackHandler",
  M1 = {
    [Ja]: !0
  },
...
let el = br;
ye(el, "_instance", null);

function on(e, t, n) {
  return "animate" in e ? e.animate(t, n) : el.create()
}
const F1 = je("<div></div>"),
  K1 = A1,
  V1 = T1,
    ...
    var r = function(B, q) {
      var P = 236,
        ...
        me = function(U, N) {
          x = E * 4 + 17, k = function($) {
            ...
            return F
          }(x), Ee(0, 0), Ee(x - 7, 0), Ee(0, x - 7), dt(), Xe(), Ct(U, N), E >= 7 && It(U), J == null && (J = Re(E, W, G)), st(J, N)
        },
        Ee = function(U, N) {
          for (var $ = -1; $ <= 7; $ += 1)
            if (!(U + $ <= -1 || x <= U + $))
        ...
        pt = function(U, N) {
          for (var $ = 0, F = 0, K = 0, te = new Array(N.length), we = new Array(N.length), fe = 0; fe < N.length; fe += 1) {
            ...
            for (var pe = 0; pe < we[fe].length; pe += 1) {
              var gn = pe + An.getLength() - we[fe].length;
              we[fe][pe] = gn >= 0 ? An.getAt(gn) : 0
            }
          }
      ...
      Q.addData = function(U, N) {
        ...
        var te = Q.getModuleCount() * U + N * 2,
          we, fe, tt, lt, pe = "",
          ct;
        for (ct = "l" + U + ",0 0," + U + " -" + U + ",0 0,-" + U + "z ", pe += '<svg version="1.1" xmlns="http://www.w3.org/2000/svg"', pe += K.scalable ? "" : ' width="' + te + 'px" height="' + te + 'px"', pe += ' viewBox="0 0 ' + te + " " + te + '" ', pe += ' preserveAspectRatio="xMinYMin meet"', pe += F.text || $.text ? ' role="img" aria-labelledby="' + ft([F.id, $.id].join(" ").trim()) + '"' : "", pe += ">", pe += F.text ? '<title id="' + ft(F.id) + '">' + ft(F.text) + "</title>" : "", pe += $.text ? '<description id="' + ft($.id) + '">' + ft($.text) + "</description>" : "", pe += '<rect width="100%" height="100%" fill="white" cx="0" cy="0"/>', pe += '<path d="', tt = 0; tt < Q.getModuleCount(); tt += 1)
        ...
        var F = Q.getModuleCount() * U + N * 2,
          K = "";
        return K += "<img", K += ' src="', K += Q.createDataURL(U, N), K += '"', K += ' width="', K += F, K += '"', K += ' height="', K += F, K += '"', $ && (K += ' alt="', K += ft($), K += '"'), K += "/>", K
      };
      var ft = function(U) {
        ...
        return E.getBCHTypeInfo = function(k) {
          ...
          for (var G = 0; G < x - 1; G += 1)
            for (var Q = 0; Q < x - 1; Q += 1) {
              var dt = 0;
              k.isDark(G, Q) && (dt += 1), k.isDark(G + 1, Q) && (dt += 1), k.isDark(G, Q + 1) && (dt += 1), k.isDark(G + 1, Q + 1) && (dt += 1), (dt == 0 || dt == 4) && (J += 3)
            }
          for (var G = 0; G < x; G += 1)
      ...
      D = function(B, q) {
        ...
        var k = function(G) {
            var Q = G,
              ...
              Ee = 0,
              Fe = {};
            return Fe.write = function(Xe, dt) {
              if (Xe >>> dt) throw "length over";
              for (; me + dt >= 8;) Q.writeByte(255 & (Xe << me | Ee)), dt -= 8 - me, Xe >>>= 8 - me, Ee = 0, me = 0;
              Ee = Xe << me | Ee, me = me + dt
            }, Fe.flush = function() {
              me > 0 && Q.writeByte(Ee)
            }, Fe
          },
          x = function(G) {
            ...
            return It.write(Fe.indexOf(st), Ee), It.write(me, Ee), It.flush(), dt.toByteArray()
          },
          J = function() {
            var G = {},
              Q = 0,
...
function ji(e) {
  return Je(this, null, function*() {
    try {
      if (!(navigator != null && navigator.clipboard)) throw new xt("Clipboard API not available");
...
const au = je("<div></div>"),
  No = e => {
    let t, n, r;
    const [o, i] = xe(!1), [a, l] = xe(Ls);
    At(() => {
      const w = iu(0, "L");
      w.addData(e.sourceUrl), w.make(), t.innerHTML = w.createSvgTag(4, 0);
      const C = t.firstElementChild.clientWidth,
        b = Math.round(nl / C * 1e5) / 1e5;
      if (r) {
        const S = Math.ceil(pi / (b * 4)) * 4,
          M = an(Math.ceil((C - S) / (2 * 4)) * 4);
        r.style.top = M, r.style.left = M, r.style.height = an(S), r.style.width = an(S), l(Math.round(Ls / b))
      }
    ...
    return d(eu, {
      ...
      onClick: () => {
        i(!0), ji(e.sourceUrl), h != null && clearTimeout(h), h = setTimeout(() => i(!1), 1500)
      },
      get children() {
        return [d(tu, {
          ref(m) {
...
`,
  ...
  Eu = e => {
    ...
    return (() => {
      ...
      return Oe(i => {
        const a = n(),
          l = n();
        return a !== i._v$ && ge(r, "fill", i._v$ = a), l !== i._v$2 && ge(o, "fill", i._v$2 = l), i
      }, {
        _v$: void 0,
        _v$2: void 0
      }), r
    ...
    return ie((() => {
      ...
      return () => o() ? (() => {
        ...
        return Oe(v => {
          ...
          return m !== v._v$ && ge(i, "class", v._v$ = m), y !== v._v$2 && ge(l, "fill", v._v$2 = y), w !== v._v$3 && ge(h, "stroke", v._v$3 = w), v
        }, {
          _v$: void 0,
          _v$2: void 0,
          _v$3: void 0
        ...
        return () => i() ? (() => {
          ...
          return Oe(v => {
            const m = e.class,
              y = r(),
              w = t.colors.constant.white;
            return m !== v._v$4 && ge(a, "class", v._v$4 = m), y !== v._v$5 && ge(l, "fill", v._v$5 = y), w !== v._v$6 && ge(h, "fill", v._v$6 = w), v
          }, {
            _v$4: void 0,
            _v$5: void 0,
            _v$6: void 0
          ...
          return Oe(v => {
            const m = e.class,
              y = r(),
              w = t.colors.constant.white;
            return m !== v._v$7 && ge(a, "class", v._v$7 = m), y !== v._v$8 && ge(l, "fill", v._v$8 = y), w !== v._v$9 && ge(h, "fill", v._v$9 = w), v
          }, {
            _v$7: void 0,
            _v$8: void 0,
            _v$9: void 0
    ...
    return ie((() => {
      ...
      return () => o() ? (() => {
        ...
        return Oe(h => {
          ...
          return v !== h._v$ && ge(i, "class", h._v$ = v), m !== h._v$2 && ge(a, "fill", h._v$2 = m), y !== h._v$3 && ge(l, "fill", h._v$3 = y), h
        }, {
          _v$: void 0,
          _v$2: void 0,
          _v$3: void 0
        ...
        return () => i() ? (() => {
          ...
          return Oe(v => {
            const m = e.class,
              y = r(),
              w = t.colors.constant.white;
            return m !== v._v$4 && ge(a, "class", v._v$4 = m), y !== v._v$5 && ge(l, "fill", v._v$5 = y), w !== v._v$6 && ge(h, "stroke", v._v$6 = w), v
          }, {
            _v$4: void 0,
            _v$5: void 0,
            _v$6: void 0
    ...
    return ie((() => {
      ...
      return () => a() ? (() => {
        const l = Iu.cloneNode(!0),
          h = l.firstChild;
        return Oe(v => {
          const m = oo(i, e.class),
            y = r();
          return m !== v._v$ && ge(l, "class", v._v$ = m), y !== v._v$2 && ge(h, "fill", v._v$2 = y), v
        }, {
          _v$: void 0,
          _v$2: void 0
        }), l
        ...
        return () => l() ? (() => {
          const h = Pu.cloneNode(!0),
            v = h.firstChild;
          return Oe(m => {
            const y = oo(i, e.class),
              w = r();
            return y !== m._v$3 && ge(h, "class", m._v$3 = y), w !== m._v$4 && ge(v, "fill", m._v$4 = w), m
          }, {
            _v$3: void 0,
            _v$4: void 0
          }), h
          ...
          return Oe(m => {
            const y = oo(i, e.class),
              w = r();
            return y !== m._v$5 && ge(h, "class", m._v$5 = y), w !== m._v$6 && ge(v, "stroke", m._v$6 = w), m
          }, {
            _v$5: void 0,
            _v$6: void 0
          }), h
  ...
  Nu = () => {
    const e = it(),
      t = () => e.theme === gt.DARK ? e.colors.constant.white : e.colors.constant.black;
    return (() => {
      const n = Uu.cloneNode(!0),
        r = n.firstChild,
        o = r.nextSibling,
        i = o.nextSibling;
      return Oe(() => ge(i, "fill", t())), n
    })()
  },
  ...
  Ju = e => {
    ...
    return (() => {
      ...
      return Oe(i => {
        const a = e.class,
          l = n();
        return a !== i._v$ && ge(r, "class", i._v$ = a), l !== i._v$2 && ge(o, "fill", i._v$2 = l), i
      }, {
        _v$: void 0,
        _v$2: void 0
      }), r
...
`,
  [vd, md] = xe(((hs = dn()) == null ? void 0 : hs.innerHeight) || 0);
dn() && window.addEventListener("resize", () => md(window.innerHeight));
const [dr, wd] = xe(or("mobile")), Eo = () => wd(or("mobile"));
dn() && (window.addEventListener("resize", () => Eo()), window.addEventListener("load", () => Eo(), {
  once: !0
}));
const cl = e => {
    const [t, n] = xe(!1), r = a => {
  ...
  Cd = e => {
    ...
    return (() => {
      ...
      return Oe(a => {
        const l = n(),
          h = n();
        return l !== a._v$ && ge(o, "fill", a._v$ = l), h !== a._v$2 && ge(i, "fill", a._v$2 = h), a
      }, {
        _v$: void 0,
        _v$2: void 0
      }), r
  ...
  Ad = e => {
    const t = Ht(Dn),
      ...
      o = () => Je(void 0, null, function*() {
        const a = ya(t.account.address, t.account.chain === ao.TESTNET);
        yield ji(a), r(!0), setTimeout(() => r(!1), 1e3)
      }),
      i = () => {
...
function Od(e) {
  ...
  return At(qc(pn, a => {
    var l;
    if (!a || !a.showNotification || Is() === a || ((l = Is()) == null ? void 0 : l.name) === "confirm-transaction" && a.name === "confirm-transaction") return;
...
function Yd(e) {
  return ["top", "bottom"].includes(dl(e)) ? "x" : "y"
}
...
function fl() {
  ...
  return e && Array.isArray(e.brands) ? (eo = e.brands.map(t => t.brand + "/" + t.version).join(" "), eo) : navigator.userAgent
}
...
function qi(e) {
  return ["html", "body", "#document"].includes(Wn(e))
}
const Ns = Math.min,
  Ar = Math.max,
  Ds = Math.round,
...
function Wr(e) {
  ...
  if (r.boxSizing !== "border-box") return un(t) ? {
    x: t.offsetWidth > 0 && Ds(n.width) / t.offsetWidth || 1,
    y: t.offsetHeight > 0 && Ds(n.height) / t.offsetHeight || 1
  } : xi;
...
function Un(e, t, n, r) {
  ...
  let v = xi;
  t && (r ? Qt(r) && (v = Wr(r)) : v = Wr(e));
  const m = Qt(e) ? En(e) : window,
    y = !gl() && n,
...
function vl(e) {
  return Un(On(e)).left + jo(e).scrollLeft
}
...
function Ur(e) {
  ...
  const t = e.assignedSlot || e.parentNode || (Us(e) ? e.host : null) || On(e);
...
function js(e) {
  const t = En(e);
  let n = Os(e);
  for (; n && Xd(n) && cn(n).position === "static";) n = Os(n);
  return n && (Wn(n) === "html" || Wn(n) === "body" && cn(n).position === "static" && !Vi(n)) ? t : n || tf(e) || t
}
...
function rf(e) {
  ...
  if ((o || !o && r !== "fixed") && ((Wn(n) !== "body" || Oo(i)) && (a = jo(n)), un(n))) {
    const v = Un(n);
    l = Wr(n), h.x = v.x + n.clientLeft, h.y = v.y + n.clientTop
  }
  return {
    width: t.width * l.x,
    height: t.height * l.y,
...
function ml(e) {
  const t = Ur(e);
  return qi(t) ? e.ownerDocument.body : un(t) && Oo(t) ? t : ml(t)
}
...
function Tr(e, t) {
  ...
  const r = ml(e),
    ...
    i = En(r);
  return o ? t.concat(i, i.visualViewport || [], Oo(r) ? r : []) : t.concat(r, Tr(r))
}
...
function Hs(e, t, n) {
  return t === "viewport" ? Ws(of(e, n)) : Qt(t) ? af(t, n) : Ws(sf(On(e)))
}

function lf(e, t) {
  const n = t.get(e);
  if (n) return n;
  let r = Tr(e).filter(l => Qt(l) && Wn(l) !== "body"),
    o = null;
  ...
  for (; Qt(a) && !qi(a);) {
    const l = cn(a),
      h = Vi(a);
    (i ? !h && !o : !h && l.position === "static" && !!o && ["absolute", "fixed"].includes(o.position)) ? r = r.filter(m => m !== a): o = l, a = Ur(a)
  }
  return t.set(e, r), r
}
...
function cf(e) {
  ...
  const a = [...n === "clippingAncestors" ? lf(t, this._c) : [].concat(n), r],
    ...
    h = a.reduce((v, m) => {
      const y = Hs(t, m, o);
      return v.top = Ar(y.top, v.top), v.right = Ns(y.right, v.right), v.bottom = Ns(y.bottom, v.bottom), v.left = Ar(y.left, v.left), v
    }, Hs(t, l, o));
  return {
...
const uf = {
  ...
  getElementRects(e) {
    return Je(this, null, function*() {
      ...
      const o = this.getOffsetParent || js,
...
const gf = je('<tc-root data-tc-dropdown-container="true"></tc-root>'),
  vf = () => {
    ...
    const [m, y] = xe(), [w, C] = xe(), b = hf(w, m, {
      ...
      const V = i();
      if (V) {
        const D = ya(V.address, V.chain === ao.TESTNET);
                  ...
                  get children() {
                    return [d(Fd, {
                      ...
                      get children() {
                        ...
                        return ir(y, V), V.style.setProperty("z-index", "999"), V._$owner = Zc(), Rt(V, d(Oi, {
                          onBeforeEnter: D => {
                            on(D, [{
                              opacity: 0,
                              transform: "translateY(-8px)"
...
function pf(e) {
  return "jsBridgeKey" in e ? Gt(et({}, e), {
    injected: Gn.isWalletInjected(e.jsBridgeKey),
    embedded: Gn.isInsideWalletBrowser(e.jsBridgeKey)
  }) : e
}
...
function ot(e, t) {
  ...
  return r.slice(0, r.lastIndexOf("&")) + "-" + na(o)
}
...
function qr(e, t) {
  ...
  const n = Of(e),
    r = new URL(n);
  if (r.searchParams.has("startapp") || r.searchParams.append("startapp", "tonconnect"), za()) {
    t.returnStrategy = "back";
    const o = ot(r.toString(), t.returnStrategy);
    at(o)
  } else if (ln())
    if (Fn("ios", "android", "macos", "tdesktop", "web")) {
      t.returnStrategy = "back";
      const o = ot(r.toString(), t.returnStrategy);
      wi(o)
    } else Fn("weba") ? wi(ot(r.toString(), t)) : at(ot(r.toString(), t));
  else if (Xt("ios")) {
...
function Zr(e, t, n, r) {
  if (n = et({}, n), za())
    ...
    } else if (Fn("macos", "tdesktop")) {
    n.returnStrategy === "back" && (n.returnStrategy = "tg://resolve");
    const o = ot(e, n.returnStrategy);
    !!t && !n.forceRedirect ? (r("custom-deeplink"), $n(Jr(o, t), () => {
      r("universal-link"), at(o)
    })) : (r("universal-link"), at(o))
  } else if (Fn("weba")) {
...
const bl = e => {
    ...
    At(() => {
      Mt(t) !== "extension" && (Lr(e.wallet) || Fs(e.wallet)) && y()
    });
    const w = () => {
      ...
      C = () => {
        if (o(!1), t() === "extension" && y(), n("desktop"), Rn(i())) b();
        else {
          const M = !l();
          h(!1), Zr(i(), e.wallet.deepLink, {
      ...
      S = () => {
        o(!1), n("extension"), Vn(e.wallet) && (Bt(e.wallet), v.connect({
          jsBridgeKey: e.wallet.jsBridgeKey
        }, e.additionalRequest))
      };
    return Lr(e.wallet) ? w() : Ks(e.wallet) ? S() : C(), d(Tf, {
            ...
            return d(If, {
              get children() {
                return [d(_e, {
                  ...
                  get when() {
                    return ie(() => t() !== "extension")() && Ks(e.wallet)
                  },
                  get children() {
                    return d(ei, {
                      appearance: "secondary",
                  ...
                  get when() {
                    return ie(() => t() !== "desktop")() && Fs(e.wallet)
                  },
                  get children() {
                    return d(ei, {
                      appearance: "secondary",
...
function _l(e) {
  const t = new Set(e.filter(Ai).map(n => n.bridgeUrl));
...
const Ys = je("<li></li>"),
  ...
  w4 = e => {
    const [t, n] = xe(!1), [r, o] = xe(!0), [i, a] = xe(null), l = Ge.connector, h = () => e.walletsList.filter(D => Lr(D) && D.appName !== xn), v = () => h().length > 7, m = ie(() => _l(e.walletsList), null, {
      equals: El
    ...
    const [w, C] = xe(void 0), b = () => Je(void 0, null, function*() {
      w() !== void 0 && clearTimeout(w()), yield ji(y());
      ...
      a(null);
      const D = e.walletsList.find(q => q.appName === xn);
      if (!D || !Ai(D)) throw new xt("@wallet bot not found in the wallets list");
      const z = l.connect({
...
const _4 = je("<li></li>"),
  E4 = e => {
    const [t, n] = xe(!1), r = Ge.connector, o = ie(() => _l(e.walletsList), null, {
      equals: El
    });
    Bt({
      openMethod: "qrcode"
  ...
  k4 = () => {
    ...
    const t = Ht(gr),
      ...
      m = ie(() => {
        ...
        let V = Zi(r(), Ge.walletsListConfiguration);
        const D = V.filter(Vn),
          z = V.filter(E => !Vn(E));
        V = (D || []).concat(z);
        const B = Ge.preferredWalletAppName,
          q = V.find(E => Mn(E, B)),
          P = V.filter(E => Mn(E, B)).length >= 2;
        B && q && !P && (V = [Gt(et({}, q), {
          isPreferred: !0
        })].concat(V.filter(E => !Mn(E, B))));
        const R = V.find(E => Mn(E, xn));
        return R && (V = [R].concat(V.filter(E => !Mn(E, xn)))), V
      }),
      y = () => {
        var V;
...
`,
  Gi = e => {
    ...
    let l;
    n != null && n.wallet && "universalLink" in n.wallet && (n.wallet.openMethod === "universal-link" || Rn(n.wallet.universalLink) && ln()) && (l = n.wallet.universalLink);
    let h;
    n != null && n.wallet && "deepLink" in n.wallet && (n.wallet.openMethod === "custom-deeplink" || Rn(n.wallet.deepLink) && ln()) && (h = n.wallet.deepLink);
    const v = () => {
      const m = pn(),
  ...
  P4 = () => d(tl, {
    get opened() {
      var e;
      return ie(() => pn() !== null)() && ((e = pn()) == null ? void 0 : e.openModal) === !0
    },
    get enableAndroidBackHandler() {
      return Ge.enableAndroidBackHandler
    },
    ...
    get children() {
      return d(Or, {
        get children() {
          return [d($t, {
            get when() {
              return pn().name === "transaction-sent"
            },
            get children() {
              return d(I4, {
                onClose: () => rr(null)
            ...
            get when() {
              return pn().name === "transaction-canceled"
            },
            get children() {
              return d(B4, {
                onClose: () => rr(null)
            ...
            get when() {
              return pn().name === "confirm-transaction"
            },
            get children() {
              return d(R4, {
                onClose: () => rr(null)
  ...
  Zt = {
    openWalletsModal: () => void setTimeout(() => xs({
      status: "opened",
      closeReason: null
    })),
    closeWalletsModal: e => void setTimeout(() => xs({
      status: "closed",
      closeReason: e
    })),
    ...
    closeSingleWalletModal: e => void setTimeout(() => Ss({
      status: "closed",
      closeReason: e
    })),
...
class N4 {
  constructor(t) {
    ye(this, "connector"), ye(this, "setConnectRequestParametersCallback"), ye(this, "consumers", []), ye(this, "tracker"), ye(this, "state", gi()), this.connector = t.connector, this.tracker = t.tracker, this.setConnectRequestParametersCallback = t.setConnectRequestParametersCallback, At(() => {
      const n = gi();
  ...
  open() {
    return Je(this, null, function*() {
      ...
      const n = (yield this.connector.getWallets()).find(Bo);
  ...
  openWalletsModal() {
    return Je(this, null, function*() {
      return ln() && Di(), Zt.openWalletsModal(), new Promise(t => {
...
class O4 {
  constructor(t) {
    ye(this, "connector"), ye(this, "setConnectRequestParametersCallback"), ye(this, "consumers", []), ye(this, "tracker"), ye(this, "state", po()), this.connector = t.connector, this.tracker = t.tracker, this.setConnectRequestParametersCallback = t.setConnectRequestParametersCallback, At(() => {
      const n = po();
      this.state = n, this.consumers.forEach(r => r(n))
    })
  }
  open(t) {
    return Je(this, null, function*() {
      this.tracker.trackConnectionStarted();
      const n = yield this.connector.getWallets(), r = Zi(n, Ge.walletsListConfiguration), o = r.find(Bo);
      if (!!o) return this.connectEmbeddedWallet(o);
      const l = r.filter(Ai).find(m => Mn(m, t));
      if (!!l) return this.openSingleWalletModal(l);
      const v = `Trying to open modal window with unknown wallet "${t}".`;
      throw this.tracker.trackConnectionError(v), new xt(v)
    })
  }
  close(t = "action-cancelled") {
  ...
  openSingleWalletModal(t) {
    return Je(this, null, function*() {
      return ln() && Di(), Zt.openSingleWalletModal(t), new Promise(n => {
...
class j4 {
  constructor(t) {
    ...
    var n;
    this.eventDispatcher = (n = t == null ? void 0 : t.eventDispatcher) != null ? n : new pa, this.tonConnectUiVersion = t.tonConnectUiVersion, this.init().catch()
  }
  get version() {
    return zn({
      ton_connect_sdk_lib: this.tonConnectSdkVersion,
  ...
  setRequestVersionHandler() {
    return Je(this, null, function*() {
      yield this.eventDispatcher.addEventListener("ton-connect-ui-request-version", () => Je(this, null, function*() {
        yield this.eventDispatcher.dispatchEvent("ton-connect-ui-response-version", aa(this.tonConnectUiVersion))
      }))
    })
  }
      ...
      return new Promise((t, n) => Je(this, null, function*() {
        try {
          yield this.eventDispatcher.addEventListener("ton-connect-response-version", r => {
            ...
            once: !0
          }), yield this.eventDispatcher.dispatchEvent("ton-connect-request-version", sa())
        } catch (r) {
          n(r)
        }
      }))
...
class K4 {
  constructor(t) {
    ...
    else if (t && "manifestUrl" in t && t.manifestUrl) this.connector = new Gn({
      manifestUrl: t.manifestUrl,
      eventDispatcher: t == null ? void 0 : t.eventDispatcher
    });
    else throw new xt("You have to specify a `manifestUrl` or a `connector` in the options.");
    this.tracker = new j4({
      eventDispatcher: t == null ? void 0 : t.eventDispatcher,
      ...
      connector: this.connector
    }), this.walletsList = this.getWallets(), this.walletsList.then(o => ja(mf(o.map(i => i.imageUrl))));
  ...
  set uiOptions(t) {
    var n, r, o, i, a;
    this.checkButtonRootExist(t.buttonRootId), this.actionsConfiguration = t.actionsConfiguration, (n = t.uiPreferences) != null && n.theme ? ((r = t.uiPreferences) == null ? void 0 : r.theme) !== "SYSTEM" ? ((o = this.systemThemeChangeUnsubscribe) == null || o.call(this), Yo(t.uiPreferences.theme, t.uiPreferences.colorsSet)) : (Yo(I0(), t.uiPreferences.colorsSet), this.systemThemeChangeUnsubscribe || (this.systemThemeChangeUnsubscribe = P0(Yo))) : (i = t.uiPreferences) != null && i.colorsSet && p1(t.uiPreferences.colorsSet), (a = t.uiPreferences) != null && a.borderRadius && w1(t.uiPreferences.borderRadius), to(l => {
      var h, v;
      const m = Bn(et(et(et(et({}, t.language && {
        language: t.language
  ...
  connectWallet() {
    return Je(this, null, function*() {
      const n = (yield this.getWallets()).find(Bo);
  ...
  sendTransaction(t, n) {
    return Je(this, null, function*() {
      if (this.tracker.trackTransactionSentForSignature(this.wallet, t), !this.connected) throw this.tracker.trackTransactionSigningFailed(this.wallet, t, "Wallet was not connected"), new xt("Connect wallet to send a transaction.");
      ln() && Di();
      const {
        notifications: r,
        modals: o,
      ...
      const h = () => {
          v.signal.aborted || (Zt.setAction({
            ...
            openModal: o.includes("before"),
            sent: !0
          }), this.walletInfo && "universalLink" in this.walletInfo && (this.walletInfo.openMethod === "universal-link" || this.walletInfo.openMethod === "custom-deeplink") && (Rn(this.walletInfo.universalLink) ? qr(this.walletInfo.universalLink, {
            returnStrategy: i,
            twaReturnUrl: a || Ge.twaReturnUrl,
            forceRedirect: !1
          }) : Zr(this.walletInfo.universalLink, this.walletInfo.deepLink, {
            returnStrategy: i,
            forceRedirect: !1
          }, () => {})))
        },
      ...
      try {
        ...
        }), y instanceof ve ? y : (console.error(y), new xt("Unhandled error:" + y))
      } finally {
        m()
      }
    })
  ...
  waitForWalletConnection(t) {
    return Je(this, null, function*() {
      return new Promise((n, r) => {
        ...
        if (i && i.aborted) return this.tracker.trackConnectionError("Connection was cancelled"), r(new xt("Wallet was not connected"));
        const a = v => Je(this, null, function*() {
            if (v) this.tracker.trackConnectionCompleted(v), h(), n(v);
              ...
              h(), r(new xt("Wallet was not connected"))
            }
          }),
          l = v => {
  ...
  waitForSendTransaction(t, n) {
    return Je(this, null, function*() {
      return new Promise((r, o) => {
        ...
        if (a.aborted) return this.tracker.trackTransactionSigningFailed(this.wallet, i, "Transaction was cancelled"), o(new xt("Transaction was not sent"));
        const l = m => Je(this, null, function*() {
          ...
          v = () => {
            this.tracker.trackTransactionSigningFailed(this.wallet, i, "Transaction was cancelled"), o(new xt("Transaction was not sent"))
          };
  ...
  setPreferredWalletAppName(t) {
    this.preferredWalletStorage.setPreferredWalletAppName(t), to({
  ...
  getSelectedWalletInfo(t) {
    return Je(this, null, function*() {
      ...
      if ("name" in n) r = n;
        ...
        const i = Zi(yield this.walletsList, Ge.walletsListConfiguration).find(a => Mn(a, t.device.appName));
        if (!i) throw new xt(`Cannot find WalletInfo for the '${t.device.appName}' wallet`);
        r = et(et({}, i), n)
      }
      return r
    })
  ...
  updateWalletInfo(t) {
    return Je(this, null, function*() {
      ...
      this.walletInfo = (yield this.walletsList).find(o => Mn(o, t.device.appName)) || null
    })
  }
  ...
  checkButtonRootExist(t) {
    if (t != null && !document.getElementById(t)) throw new xt(`${t} element not found in the document.`)
  }
...
export {
  Mo as BadRequestError, pa as BrowserEventDispatcher, ao as CHAIN, Ln as CONNECT_EVENT_ERROR_CODES, Ji as CONNECT_ITEM_ERROR_CODES, ki as FetchWalletsError, uo as ParseHexError, er as SEND_TRANSACTION_ERROR_CODES, gt as THEME, Gn as TonConnect, ve as TonConnectError, K4 as TonConnectUI, xt as TonConnectUIError, $o as UnknownAppError, In as UnknownError, Lo as UserRejectsError, _i as WalletAlreadyConnectedError, co as WalletNotConnectedError, Ei as WalletNotInjectedError, si as WalletsListManager, tr as WrongAddressError, ca as createConnectionCompletedEvent, ua as createConnectionErrorEvent, fa as createConnectionRestoringCompletedEvent, ha as createConnectionRestoringErrorEvent, da as createConnectionRestoringStartedEvent, la as createConnectionStartedEvent, wa as createDisconnectionEvent, sa as createRequestVersionEvent, aa as createResponseVersionEvent, ga as createTransactionSentForSignatureEvent, va as createTransactionSignedEvent, ma as createTransactionSigningFailedEvent, zn as createVersionInfo, na as encodeTelegramUrlParameters, Rn as isTelegramUrl, Bo as isWalletInfoCurrentlyEmbedded, Vn as isWalletInfoCurrentlyInjected, uc as isWalletInfoInjectable, Ai as isWalletInfoRemote, ya as toUserFriendlyAddress
};