import {
  ...
  i as I,
  v as H
} from "./index-CeNYgm2H.js";
import z from "./Alliance-BtoZtTCH.js";
import K from "./Boost-CZ_YaPX3.js";
const O = {
    name: "Feed-g",
    components: {},
    async created() {},
...
function Cs(e, s, d, c, r, o) {
  ...
  return l(), a("div", null, [h(g, {
    ...
    default: p(() => [t("div", ve, "#" + i(r.openPoint.position), 1), o.availableForBuySpecial.length > 0 ? (l(), a("div", we, [t("div", Ae, i(e.t("Special Time Offer")), 1), (l(!0), a(m, null, C(o.availableForBuySpecial, n => (l(), a("div", {
      key: n.key,
      class: "animalForBuy"
    }, [t("div", null, [t("img", {
      ...
      _: 1
    }, 8, ["onClick"])])), o.notAvailableForBuySpecial.length > 0 ? (l(), a("div", He, [t("div", ze, i(e.t("Unavailable offers")), 1), (l(!0), a(m, null, C(o.notAvailableForBuySpecial, n => (l(), a("div", {
      key: n.key,
      class: "animalForBuy"
    }, [t("div", null, [t("img", {
      src: "/assets/img/animals/" + n.key + ".png",
    ...
    }, null, 8, Ke)]), t("div", Oe, [t("div", Ue, i(n.title), 1), t("div", null, [u("+" + i(e._number(n.level1data.profit)) + " ", 1), s[26] || (s[26] = t("span", {
      class: "tph24"
    }, null, -1)), s[27] || (s[27] = u()), t("span", xe, i(e.t("Tokens per Hour")), 1)])]), t("div", null, [n.timeToStart > 0 ? (l(), a("div", We, [u(i(e.t("Sales start in")) + " ", 1), h(S, {
      time: n.timeToStart,
